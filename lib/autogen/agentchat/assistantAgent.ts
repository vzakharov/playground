...
export class AssistantAgent extends ConversableAgent {
  ...
  Reply "TERMINATE" in the end when everything is done.` as const;

  /**
   * Construct an {@link AssistantAgent}.
   * 
   * @param name - The agent name.
   * @param options - Optional constructor parameters (see {@link AssistantAgentOptions}).
   */
  constructor(
    name: string,
    ...
    super(name, {
      systemMessage: AssistantAgent.DEFAULT_SYSTEM_MESSAGE,
